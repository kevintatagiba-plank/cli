import type { BetaMessage, BetaMessageParam, BetaToolResultBlock, BetaContentBlock, BetaLocalContentBlock, BetaTextBlock } from '../types/beta';
...
export const PROMPT_CACHING_BETA_FLAG = 'prompt-caching-2024-07-31';
